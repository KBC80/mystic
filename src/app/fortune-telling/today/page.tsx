...
export default function TodaysFortunePage() {
  ...
  const [targetFieldNameForHanja, setTargetFieldNameForHanja] = useState<FieldPath<TodaysFortuneFormValues> | null>(null);
  ...
  const handleOpenHanjaModal = (fieldName: FieldPath<TodaysFortuneFormValues>) => {
