...
import { Home, CalendarHeart, TrendingUp, Star, Sparkles, LayoutGrid, WandSparkles as WandIcon, Sigma } from 'lucide-react';
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription className="break-words">
            다양한 운세 서비스를 통해 당신의 오늘, 올해, 별자리, 타로, 룬 문자, 수비학적 기운을 확인해보세요.
          </CardDescription>
        </CardHeader>
