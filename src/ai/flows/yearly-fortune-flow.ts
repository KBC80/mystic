...
const GetYearlyFortuneOutputSchema = z.object({
  ...
  luckyNumbers: z
    ...
    .length(3)
    .describe('올해 운세 분석과 사주 정보를 종합적으로 고려한, 1에서 45 사이의 **서로 다른** 행운의 숫자 3개를 **다양하게, 특정 숫자에 편향되지 않도록** 추천합니다.'),
...
8.  **행운의 숫자 (luckyNumbers)**: **올해 운세 분석과 사주 정보를 종합적으로 고려하여** 1부터 45 사이의 올해의 **서로 다른** 행운의 숫자 3개를 **다양하게, 특정 숫자에 편향되지 않도록** 추천해주세요.
